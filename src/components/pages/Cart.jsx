...
const Cart = ({ open, setOpen }) => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50 bg-black opacity-95">
        <div
          className="m-auto my-6 w-screen max-w-sm rounded-lg border bg-white border-gray-200 p-4 pt-4 shadow-sm sm:p-6 lg:p-8"
          aria-modal="true"
          role="dialog"
          tabIndex={-1}
        >
          <button
            ...
            className="relative ml-auto block text-gray-600 transition hover:scale-110"
          >
          ...
          <div className="mt-6 space-y-6">
            <ul className="space-y-4">
              <li className="flex items-center gap-4">
                ...
                />
                <div>
                  <h3 className="text-sm">Nike Air Force 1 07 LV8</h3>
                  <dl className="mt-0.5 space-y-px text-[10px]">
                    <div>
                      <dd className="inline font-bold text-white"></dd>
                    </div>
                    <div>
